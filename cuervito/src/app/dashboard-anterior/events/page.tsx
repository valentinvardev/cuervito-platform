  ...
  return (
    <main className="wrap-narrow">
      <div className="head">
        ...
        <Link href="/dashboard-anterior/events/new" className="btn btn-primary" data-tip="Crear un evento nuevo y empezar a subir fotos">
      ...
      {events.length > 0 && (
        <Link href="/dashboard-anterior/events/new" className="event-list-add" data-tip="Crear un evento nuevo">
          <i className="ti ti-plus" />
          Crear nuevo evento
        </Link>
      )}
