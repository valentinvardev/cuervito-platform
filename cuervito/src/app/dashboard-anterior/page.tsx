    ...
    <main className="wrap">
      ...
      <section className="section" style={{ marginTop: 4, marginBottom: 20 }}>
        ...
        <div className="action-grid">
          <Link className="action-card primary" href="/dashboard-anterior/events" data-tip="Crear eventos, subir fotos y publicar galerías">
          ...
          <Link className="action-card" href="/dashboard-anterior/ventas" data-tip="Ver cada venta con su comprador, monto y descargas">
            <div className="action-icon">
          ...
          <Link className="action-card" href="/dashboard-anterior/tienda" data-tip="Personalizar tu página pública: plantilla, colores y dominio">
            <div className="action-icon">
          ...
          <Link className="action-card" href="/dashboard-anterior/cobros" data-tip="Conectar Mercado Pago y ver cómo cobrás">
            <div className="action-icon">
              <i className="ti ti-credit-card-pay" />
            </div>
            <div>
          ...
          <Link className="action-card" href="/dashboard-anterior/perfil" data-tip="Editar tu nombre, bio y redes">
            <div className="action-icon">
          ...
          <Link className="action-card" href="/dashboard-anterior/ayuda" data-tip="Guías, preguntas frecuentes y soporte">
            <div className="action-icon">
