...
const NAV: NavItem[] = [
  ...
  {
    href: "/dashboard-anterior/events",
    label: "Eventos",
    desc: "Subí fotos, publicá, gestioná.",
    icon: "ti-calendar-event",
  },
  {
    href: "/dashboard-anterior/ventas",
    label: "Ventas",
    desc: "Detalle de cada compra.",
    icon: "ti-chart-bar",
  },
  {
    href: "/dashboard-anterior/tienda",
    label: "Página de venta",
    desc: "Tu storefront público.",
    icon: "ti-template",
  },
  {
    href: "/dashboard-anterior/cobros",
    label: "Método de pago",
    desc: "Conexión con Mercado Pago.",
    icon: "ti-credit-card",
  },
  {
    href: "/dashboard-anterior/perfil",
    label: "Perfil",
    desc: "Datos personales y bio.",
    icon: "ti-user",
  },
  {
    href: "/dashboard-anterior/ayuda",
    label: "Ayuda",
...
export function AdminDrawer() {
  const pathname = usePathname() ?? "/dashboard-anterior";
