...
import { AdminAvatar } from "~/app/admin/_components/admin-avatar";
...
export function AdminTopClient({
  ...
  const isRoot = pathname === "/dashboard-anterior";
  ...
  return (
    <header className="adm-top">
      ...
      <div className="adm-top-center">
        <Link href="/dashboard-anterior" className="logo">
